        ...
        <div className="mt-6 space-y-4">
          ...
          <nav className="space-y-2">
            ...
            >
              ...
              Checkout
              <Badge variant="secondary" className="ml-auto">{cartCount}</Badge>
            </Link>
          </nav>
          ...
          <div className="hidden md:flex items-center justify-end space-x-2">
            <form onSubmit={handleSearch} className="relative">
              ...
              <Input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="pl-10 w-[150px] lg:w-[200px]"
              />
            </form>
            ...
            <Button variant="ghost" size="icon" asChild>
                <Link to="/wishlist" className="relative">
                    ...
                    {wishlistCount > 0 && <Badge variant="secondary" className="absolute -right-1 -top-1 h-4 w-4 justify-center p-1 text-xs">{wishlistCount}</Badge>}
            ...
            <Button variant="ghost" size="icon" asChild>
                <Link to="/checkout" className="relative">
                    ...
                    {cartCount > 0 && <Badge variant="secondary" className="absolute -right-1 -top-1 h-4 w-4 justify-center p-1 text-xs">{cartCount}</Badge>}
